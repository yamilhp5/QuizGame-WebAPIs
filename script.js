...
var timer = 20;
var questionIndex = 0; // Define questionIndex variable
...
var question = [
  ...
  {
    question: "What is the name of the planet with the most rings?",
...
function endGame() {
  ...
  localStorage.setItem("userScore", questionIndex);
}
...
function getUserScore() {
  ...
  if (userScore) {
    ...
    console.log("User's score not found in local storage.");
  }
}

// Call the function to retrieve user's score
getUserScore();
